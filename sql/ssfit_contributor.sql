...
CREATE TABLE `contributor` (
  `contributorSeq` int NOT NULL AUTO_INCREMENT,
  `userSeq` int DEFAULT NULL,
  `yearMonth` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`contributorSeq`),
  KEY `userSeq_idx` (`userSeq`),
  CONSTRAINT `userSeq` FOREIGN KEY (`userSeq`) REFERENCES `user` (`userSeq`) ON DELETE SET NULL
...
INSERT INTO `contributor` VALUES (1,4,'2022-11'),(2,4,'2022-11');
